    ...
    <>
      ...
      <div className="shell">
        <div className="card">
          ...
          <div className="status-eyebrow failure">Deposit Failed</div>
          <div className="status-title">Payment Unsuccessful</div>
          ...
          <div className="receipt">
            ...
            <div className="receipt-row">
              <span className="receipt-key">Wallet charged</span>
              <span className="receipt-val" style={{ color: 'var(--green)' }}>No — $0.00</span>
            </div>
          </div>

          <div className="tip-box">
            <div className="tip-title">💡 Try instead</div>
            <div className="tip-body">Use Bank Transfer for a fee-free, instant deposit via your virtual account number — no card required.</div>
          </div>

          <button className="btn-danger" onClick={() => router.push('/deposit')}>
            Try Again
          </button>
